...
from mrncbf.utils.jax_utils import jax2np, jax_default_x32, tree_cat
...
def main(
    ...
    if ckpt is not None:
        ...
        CFG = run_config.int_avoid.dubins3davoid_cfg.get_pi(seed)
    ...
    run_dir = init_wandb_and_get_run_dir(CFG, "pncbf_dubins3davoid", "pncbf_dubins3davoid", name, group=group)

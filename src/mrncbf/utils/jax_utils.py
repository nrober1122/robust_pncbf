...
import mrncbf.utils.jax_types
from mrncbf.utils.jax_types import Arr, BFloat, BoolScalar, FloatScalar, Shape
...
def jax_use_double():
    ...
    mrncbf.utils.jax_types.set_current_float(np.float64)
